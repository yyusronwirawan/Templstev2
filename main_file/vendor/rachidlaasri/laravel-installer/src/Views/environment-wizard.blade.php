...
@section('title')
    <i class="ti ti-stars fa-fw" aria-hidden="true"></i>
...
@section('container')
    <div class="tabs tabs-full">
        ...
        <label for="tab1" class="tab-label">
            <i class="ti ti-world fa-2x fa-fw" aria-hidden="true"></i>
            <br />
        ...
        <label for="tab2" class="tab-label">
            <i class="ti ti-database fa-2x fa-fw" aria-hidden="true"></i>
            <br />
        ...
        <label for="tab3" class="tab-label">
            <i class="ti ti-worlds fa-2x fa-fw" aria-hidden="true"></i>
            <br />
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('domain') ? ' has-error ' : '' }}">
                    <label for="domain">
                        {{ trans('installer_messages.environment.wizard.form.domain_label') }}
                    </label>
                    <input type="text" name="domain" id="domain" value=""
                        placeholder="{{ trans('installer_messages.environment.wizard.form.domain_placeholder') }}" />
                            ...
                            <label for="broadcast_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                                    <a href="https://laravel.com/docs/5.4/broadcasting" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="ti ti-info-circle fa-fw" aria-hidden="true"></i>

        ...
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                @if (tenant('id') == null)
                    <div class="avatar av-m"
                        style="background-image: url('{{ Auth::user()->avatar ? Storage::url(Auth::user()->avatar) : asset('assets/img/avatar/avatar-1.png') }}');">
                    </div>
                ...
                @else
                    @if (config('filesystems.default') == 'local')
                        ...
                        <div class="avatar av-m"
                            style="background-image: url('{{ Auth::user()->avatar ? Storage::url(tenant('id') . '/' . Auth::user()->avatar) : asset('assets/img/avatar/avatar-1.png') }}');">
                        </div>
            ...
            <td>
                ...
                <span>
                    ...
                    @else
                        <span class="ti ti-file"></span> {{ __('Attachment') }}
                    @endif
                </span>
